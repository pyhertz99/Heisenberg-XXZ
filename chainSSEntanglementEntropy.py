...
with given parameters and plots entanglement entropy
of given site as a function of time.
"""
...
entropy_array_ss = lm.entanglementEntropyArray(psi_array, site, spin_basis, M, t_steps)
